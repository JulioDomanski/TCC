...
func _ready():
	...
	texture_rect.texture = preload("res://assets/backgroundIntro/SetimaFoto.png")
	...
	await typewriter_text(label,
		"A resiliência do reino foi testada, mas a reconstrução avança." +
		"\nAgora, as 'Vozes da Nobreza' ecoam pelo salão." + 
		"\nA Rainha Stakeholdina e outros nobres têm suas próprias demandas e expectativas." +
		"\nÉ hora de negociar, comunicar o progresso com clareza e defender" + 
		"\nas prioridades que realmente trarão valor a Entregária."
	)

	# --- Continue button ---
	button = Button.new()
	button.text = "Avançar para o Capítulo 6"
...
func _on_continue_pressed():
	...
	capitulo_label.text = "Capítulo 6: Vozes da Nobreza"
	...
	conceitos_label.text = "Conceitos: Gestão de Stakeholders, Comunicação Efetiva\nPriorização de Backlog, Negociação"
