...
func _ready():
	...
	texture_rect.texture = preload("res://assets/backgroundIntro/QuintaFoto.png")
	...
	await typewriter_text(label,
		"Com o conselho formado, é preciso estabelecer um ritmo para a reconstrução." +
		"\nOs rituais da corte não são apenas tradição, mas a força que mantém todos alinhados." +
		"\nÉ hora de organizar o ritmo do trabalho, inspecionar o progresso e melhorar a cada ciclo."
	)

	# --- Continue button ---
	button = Button.new()
	button.text = "Avançar para o Capítulo 4"
...
func _on_continue_pressed():
	...
	capitulo_label.text = "Capítulo 4: O Ritmo da Corte"
	...
	conceitos_label.text = "Conceitos: Cerimônias do Scrum\nDaily, Review, Planning e Retrospectiva"
